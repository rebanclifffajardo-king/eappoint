 ...
 <div class="modal fade" id="profileModal">
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            ...
            <img id="form_loader1" src="../images/ajax-loader-big.gif" style="  display: block;margin-left: auto;margin-right: auto;">
            ...
            <div class="card card-widget widget-user-2">
              ...
              <div class="widget-user-header bg-white">
                <div class="widget-user-image">
                  <img class="img-circle elevation-2" src="dist/img/user7-128x128.jpg" id="doctor_pic" alt="User Avatar">
                </div>
                <!-- /.widget-user-image -->
                <h3 class="widget-user-username" id="doctor_name">-</h3>
                <h5 class="widget-user-desc" id="doctor_type">-</h5>
              </div>
              <div class="card-footer p-0">
                <ul class="nav flex-column">
                  <li class="nav-item">
                    <a href="#" class="nav-link">
                      Email Address <span class="float-right badge bg-primary" id="doctor_email">-</span>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="#" class="nav-link">
                      Contact Number <span class="float-right badge bg-info" id="doctor_phone">-</span>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="#" class="nav-link">
                      Room Number <span class="float-right badge bg-success" id="doctor_room">-</span>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="#" class="nav-link">
                      Clinic <span class="float-right badge bg-danger" id="doctor_clinic">-</span>
                    </a>
                  </li>
                </ul>
              </div>
 ...
 <div class="modal fade" id="detailsModal">
        <div class="modal-dialog modal-dialog-centered modal-xl">
          <div class="modal-content">
            ...
            <div id="modalForm" role="form" style="display: none">
  ...
  $.ajax({
       ...
       success:  function(response){
          ...
          var col="";
            ...
            var clinic_address= response[i].clinic_address;
              ...
              col+='</span>';
              col+='<span class="description">'+email+'</span> <button  id="profilebtn" data-id='+doctor_id+'  class="btn btn-primary btn-xs mt-1"  href="#"> View Profile &nbsp;  <i class="fas fa-eye"></i> </button></td>';
              col+='<td> '+clinic_name+'  <a  id="directionbtn" data-id='+doctor_id+'  class="btn btn-primary btn-xs text-white"  href="https://www.google.com/maps/search/'+clinic_address+'" target="_blank"> Directions &nbsp;  <i class="fas fa-map"></i> </a></td>';
              col+='<td> '+phone+' </td>';
              col+='<td> '+type_name+' </td>';
              col+='<td> '+room+' </td>';
              col+='<td> '+setStatus(doctor_status)+' </td>';
              col+='<td><button  id="viewbtn" data-id='+doctor_id+'  class="btn btn-success btn-sm"  href="#"> View Schedule &nbsp;  <i class="fas fa-eye"></i> </button>';
           ...
           success:  function(response){
              ...
              var col1="";
                 ...
                 for(var i=0; i<len; i++){
                  ...
                  $("#doctor_type").text(type_name);
                  $("#doctor_email").text(email);
                  $("#doctor_phone").text(phone);
                  $("#doctor_room").text(room);
                  $("#doctor_clinic").text(clinic_name);

                  $("#doctor_pic").attr('src','../images/'+doctor_pic);
...
function checkStatus(appointment_id,status){
  if(status=="ongoing")
