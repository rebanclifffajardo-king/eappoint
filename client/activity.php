        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              ...
              <table id="activitylog" class="table table-bordered" width="100%">
                  <thead>
                  <tr>
...
var data = {
  ...
  $.ajax({
       type: "POST",
       url: "php_operation/activitycode.php",
       data: data,
       dataType: 'JSON',
       success:  function(response){
        ...
        $("#activitylog tbody").append(col);

            initDatatable("#activitylog");
