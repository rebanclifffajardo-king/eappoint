...
.sidebar-light-success .nav-sidebar>.nav-item>.nav-link.active {
  ...
  <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDBtmv62_ey0rShFsFwFgPShTeDq0Ypoe8&callback=initialize"></script>
  <script>
  /*This is script*/ 
...
">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a  id="userhead" href="#" class="d-block">User </a>
        </div>
      </div>
