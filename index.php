...
<body id="top" data-spy="scroll" data-target=".navbar-collapse" data-offset="50">
                              ...
                              <div class="item item-second">
                                   <div class="caption">
                                        <div class="col-md-offset-1 col-md-10">
                                             ...
                                             <h1>Be Updated</h1>
                                             <a href="#appointment" class="section-btn btn btn-default btn-gray smoothScroll">More About Us</a>
                                        </div>
                                   </div>
                              </div>
                              ...
                              <div class="item item-third">
                                   <div class="caption">
                                        <div class="col-md-offset-1 col-md-10">
                                             ...
                                             <a href="#doctors" class="section-btn btn btn-default btn-blue smoothScroll">Meet our Doctors</a>
                                        </div>
                                   </div>
                              </div>
                         </div>
  ...
  <!-- HOME -->
  <section id="doctors" class="slider" data-stellar-background-ratio="0.5">
     <div class="container">
          <div class="row">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="images/updates/banner1_1.png" alt="image 1" style="width:100%;">
          </div>
     ...
     <div class="container-fluid">
          <img src="images/updates/banner5_1.png" width="100%" alt="">
          ...
          <div class="container">
               <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6">
                         <img src="images/updates/banner6_1.png" class="img-responsive" alt="">
                    </div>
     ...
     <div class="container-fluid">
          <img src="images/updates/banner4.jpg" width="100%" alt="">
