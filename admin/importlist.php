  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Import List</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-header border-0">
                ...
                <a href="import.php"><h3 class="card-title"><< Go back to import file</h3> </a>
              </div>
              <div class="card-body">

              <table id="importtbl" class="table table-bordered" width="100%">
                  <thead>
                  <tr>
...
function getimporttbl(){
  restartDatatable("#importtbl");
  ...
  $.ajax({
       ...
       success:  function(response){
          ...
          var col="";
            ...
            var minutes_done = response[i].minutes_done;
        ...
        $("#importtbl tbody").append(col);

            initDatatable("#importtbl");
