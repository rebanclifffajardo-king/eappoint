          ...
          <div class="col-lg-12">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <li class="nav-item"><a  id="nav-pending" class="nav-link active"  href="#">Waiting List </a></li>
                <li class="nav-item"><a  id="nav-ongoing" class="nav-link"   href="#">Completed</a></li>
                 <li class="nav-item"><a  id="nav-ongoing" class="nav-link"   href="#">Expired</a></li>
...
ws.addEventListener("open", () =>{
        console.log("You are connected to ipoint admin server!");

    });
ws.addEventListener("message", ({ data }) =>{
    //console.log("The server sent a message: " + data); 
  // console.log("You request to reload the queues to connected client..." ); 
...
function addNode(){
  ...
  ws.send("Asking Server to reload queue of clients..");
