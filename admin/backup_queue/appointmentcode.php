...
function processQueue($appointment_id){
  global $conn;
  date_default_timezone_set('Asia/Manila');
  $date=date('Y-m-d');
  $schedule_date = mysqli_real_escape_string($conn,$_POST['date_sched']);
...
function addQueue($appointment_id,$client_id,$schedule_date,$type_id,$doctor_id){
  ...
  $datetime_sched=getConsultationTime($doctor_id,$priorityno);
  $date_sched=mysqli_real_escape_string($conn,$_POST['date_sched']);
...
function getConsultationTime($doctor_id,$priorityno){
  global $conn;
  $date_sched=date('Y-m-d');
  $f_datetime_sched="";
  $date_sched=mysqli_real_escape_string($conn,$_POST['date_sched']);
